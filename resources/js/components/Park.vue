...
<div class="mapa-container container">
    <img class="mapa" src="../../assets/img/plano.png" alt="plano de las instalaciones del acuario">
 
    <h2 class="subtitulos" >BINIKI BOTTOM PARK</h2>
    <img src="../../assets/img/acuario1.jpg" class="imagen-mapa" style="float:left; margin-right:20px;" alt="">
...
<v-content>
    <h2 class="subtitulos" id="donde-comer">DISFRUTA DEL PLACER DEL MAR</h2>
</v-content>
